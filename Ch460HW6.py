...
# Calculate the equilibrium constant Kp from T = 800 °C  to T = 1200 °C. Convert °C to K.
...
for i in range(0, len(T)):
    ...
    print(qI,qI2)
    # Calculate Kp at T. Input partitions functions and stoichemetry. Print results. 
    Kp_iodine = Kp_Const(T[i], qI2, 1, qI, 1, 1, 0, 2, 0)
    print("At", int(T[i]-273.15), "°C , Kp = ", Kp_iodine / Pa2atm)
...
T = [1500+273.15, 2000+273.15, 2500+273.15]
...
for i in range(0, len(T)):
    ...
    print("At",int(T[i]-273.15), "°C , Kp = ", Kp_nitric)
